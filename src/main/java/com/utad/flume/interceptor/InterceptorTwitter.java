 ...
 */
        ...
        import static com.utad.flume.interceptor.InterceptorTwitterConstantes.*;
 ...
 */
public class InterceptorTwitter implements Interceptor {
    private static final Logger logger =
            LoggerFactory.getLogger(InterceptorTwitter.class);
    ...
    /**
     * Only {@link InterceptorTwitter.Builder} can build me
     */
    private InterceptorTwitter(boolean outputText, boolean outputUserName, boolean outputUserScreenName) {
    ...
    public List<Event> intercept(List<Event> events) {
        ...
        for (Event event : events) {
            ...
            event.getHeaders().put("SINKTYPE", "KAFKAJSON");
            es.add(event);
        }
        return es;
    }
    ...
    /**
     * Builder which builds new instances of the InterceptorTwitter.
     */
    public static class Builder implements Interceptor.Builder {
        ...
        public Interceptor build() {
            return new InterceptorTwitter(outputText, outputUserName, outputUserScreenName);
        }
